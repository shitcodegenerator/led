...
items-start sm:items-center">
      ...
      <input v-if="i.type !== 'checkbox'" v-model="i.value" :placeholder="i.placeholder" :type="i.type ?? 'text'"/>
      
      <div v-if="i.type === 'checkbox'" class="gap-2 flex flex-row items-center justify-center">
